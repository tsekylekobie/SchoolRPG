function ScienceHomework(x, y, stats, canvasID, handler){
    Homework.apply(this, arguments);
    this.name = "Science Homework";
    this.img = new Image();
    this.img.src = 'Entity/Homework/sciencehw.jpg';
    this.dead = false;
    this.levelUp = ()=>{
        this.level++;
    ...
    this.moves = [
        ...
        {name:"Science", type:"Scissors", energy:100, baseDamage:100}
    ];
    this.render = ()=> {
        if(this.visible){
