function EnglishHomework(x, y, stats, canvasID, handler){
    Homework.apply(this, arguments);
    this.name = "English Homework";
    this.img = new Image();
    this.img.src = 'Entity/Homework/englishhw.jpg';
    this.dead = false;
    this.levelUp = ()=>{
        this.level++;
    ...
    this.moves = [
        ...
        {name:"English", type:"Scissors", energy:100, baseDamage:100}
    ];
    this.render = ()=> {
        if(this.visible){
